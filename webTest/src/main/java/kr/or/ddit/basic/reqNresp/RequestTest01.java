...
public class RequestTest01 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<html><head><meta charest='utf-8'><title>Request객체 연습</title></head>");
		out.println("<body>");
		...
		out.println("<li>CntextPath : "+ request.getContextPath()+"</li>");
		out.println("<li>프로토콜 : "+ request.getProtocol()+"</li>");
		out.println("<li>URL정보 : "+ request.getRequestURL()+"</li>");
		out.println("<li>URI : "+ request.getRequestURI()+"</li>");
		out.println("</ul>");
