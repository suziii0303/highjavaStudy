...
public class ResponseTest02 extends HttpServlet {
	...
	/*
		  ...
		  * 응답시 브라우저에게 '이동할URL'를 전송하여 브라우저가 해당 URL로 이동하는 방식이다.
		  * 이동할 때의 전송방식은 GET방식으로 여청하여 이동한다.
		  * (URL의 길이에 제한이 있다.)
	*/
	/*
		// redirect는 Requdst객체를 공유하지 못한다.( 브라우저에서 새롭게 요청하기 때문에..)
	...
	*/
		...
		// URL경로에 한글이 포함될 경우에는 URLEncoder객체를 이용하여 인코딩해서 지정해 주어야한다.
