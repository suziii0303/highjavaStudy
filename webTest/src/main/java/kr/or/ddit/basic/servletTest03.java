...
/*
	- Servlet의 동작 과정...
1. 사용자(클라이언트)가 URL을 클릭하면 HTTP요청을 Servlet Container로 전송한다.(요청작업)
...
public class servletTest03 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			out.println("<body><h1 style='color:blue;'>doGet()메서드를 처리한 결과입니다.</h2></body></html>");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<html><head><meta charset='utf-8'></head>");
		out.println("<body><h1 style='color:red;'>doPost()메서드를 처리한 결과입니다.</h2></body></html>");
