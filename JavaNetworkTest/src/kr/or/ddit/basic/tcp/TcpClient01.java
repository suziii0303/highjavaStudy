...
public class TcpClient01 {
	public static void main(String[] args) throws UnknownHostException, IOException {
		/*
		- 현재 자신의 컴퓨터를 나타내는 방법
		1) 원래의 IP주소 : 예) 192.168.56.1
		2) 지정된 IP주소 : 127.0.0.1
		3) 원래 컴퓨터 이름 : 예) DESKTOP-MEGJA89
...
//		Socket socket = new Socket("192.168.56.1",7777);
		...
		// 이 Socket객체의 생성하는 명령 이후는 서버와 연결이 완료된 후에 처리할 내용을 기술하면 된다.
		
		System.out.println("서버에 연결 되었습니다...");
		System.out.println();
		
		// 상대방이 보낸 메시지 받기...
		// 상대방에게 메시지를 받는 다는 것은 Socket으로 입력 받는 것을 의미한다.
